...
public class Test_TEST_properties {

	private static final String TARGET_PLATFORM = "TEST";
	...
	public void testServiceAInfo() {
		...
		assertThat(serviceAInfo.service_url).isEqualTo("http://192.168.0.102:8080/ws/service_a");
	...
	public void testServiceBInfo() {
		...
		assertThat(serviceBInfo.service_url).isEqualTo("http://192.168.0.102:8080/ws/service_b");
